...
{{
  ...
  "narrative_summary": "A comprehensive executive summary in RICH MARKDOWN format (3-6 paragraphs with proper structure).\n\n**IMPORTANT**: Use proper markdown formatting:\n- Use ## for main section headings\n- Use ### for subsection headings\n- Use **bold** for key terms and emphasis\n- Use *italics* for subtle emphasis\n- Use bullet points (- or *) for lists\n- Use numbered lists (1., 2., 3.) where appropriate\n- Break into clear paragraphs with blank lines between them\n\nCover: main topics, key decisions, outcomes, overall meeting flow, and important context.",
